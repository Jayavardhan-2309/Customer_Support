...
export function Card({ title, subtitle, children }: Readonly<CardProps>) {
  return (
    <section className="group overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.96),rgba(2,6,23,0.96))] p-4 shadow-[0_24px_80px_-48px_rgba(14,165,233,0.65)] transition duration-300 hover:border-cyan-400/30 hover:shadow-[0_28px_90px_-46px_rgba(56,189,248,0.5)] sm:p-5">
