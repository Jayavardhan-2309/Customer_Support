      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-6 sm:px-6 sm:py-8 lg:space-y-10 lg:px-8 lg:py-10">
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Card title="Category volume" subtitle="Ticket count by category">
            <BarMetricChart
              data={categoryData}
              bars={[{ dataKey: "value", color: "#38bdf8" }]}
              emptyMessage="Category volume data is not available yet"
            />
          </Card>
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Card title="Daily efficiency" subtitle="Resolved percentage against created tickets over the last 14 days">
            <AreaMetricChart
              data={efficiencyData}
              areas={[{ dataKey: "efficiency", stroke: "#22d3ee", fill: "#22d3ee" }]}
              emptyMessage="Efficiency data is not available yet"
            />
          </Card>
          <Card title="Cumulative flow" subtitle="Running total of opened versus resolved tickets">
            <AreaMetricChart
              data={cumulativeData}
              areas={[
                { dataKey: "Opened", stroke: "#38bdf8", fill: "#38bdf8" },
                { dataKey: "Resolved", stroke: "#34d399", fill: "#34d399" },
              ]}
