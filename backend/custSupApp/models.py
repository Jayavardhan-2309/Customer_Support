...
class User(AbstractUser):
    ...
    # Staff-only fields (ignored for normal users)
...
class UploadedPDF(models.Model):
    """Tracks PDFs uploaded by admins for knowledge base context."""
    title = models.CharField(max_length=200)              # original filename
    file = models.FileField(upload_to='pdfs/')            # saved in media/pdfs/
