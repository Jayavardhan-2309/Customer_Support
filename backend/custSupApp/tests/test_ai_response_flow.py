...
class TestAIResponseFlow(unittest.TestCase):
    @patch("ai_assistant.ai.handle_escalation", return_value=None)
    @patch("ai_assistant.ai.extract_repetition", return_value=None)
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=["doc"])
    @patch("ai_assistant.ai.call_groq", return_value='{"intent":"general","reply":"answer","confidence":0.8}')
    @patch("ai_assistant.ai.evaluate_escalation_risk", return_value=False)
    ...
    @patch("ai_assistant.ai.handle_escalation")
    ...
    @patch("ai_assistant.ai.extract_repetition", return_value=None)
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=[])
    @patch("ai_assistant.ai.call_groq", return_value='{"intent":"unknown","reply":"no answer","confidence":0.2}')
    ...
    @patch("ai_assistant.ai.handle_escalation", return_value=None)
    @patch("ai_assistant.ai.extract_repetition", return_value=("escalation", "repeat", 0.0, True))
    ...
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=["doc"])
    @patch("ai_assistant.ai.call_groq", return_value='{"intent":"billing","reply":"needs help","confidence":0.4}')
    @patch("ai_assistant.ai.evaluate_escalation_risk", return_value=True)
    ...
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=[])
    @patch("ai_assistant.ai.call_groq", return_value='{"intent":"general","reply":"hello there","confidence":0.9}')
    ...
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=["doc"])
    @patch("ai_assistant.ai.call_groq", return_value="not json")
    ...
    @patch("ai_assistant.ai.is_user_frustrated", return_value=False)
    @patch("ai_assistant.ai.search_similar_chunks", return_value=["doc"])
    @patch("ai_assistant.ai.call_groq", return_value="{bad json}")
    ...
    @patch("ai_assistant.ai.call_ollama", return_value=None)
